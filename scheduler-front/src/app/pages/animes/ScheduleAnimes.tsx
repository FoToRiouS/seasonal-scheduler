...
export const ScheduleAnimes = () => {
    ...
    const filterAndOrderList = useCallback(
            ...
            if (data) {
                ...
                if (searchValue) {
                    filtered = filtered?.filter((a) => {
                        return (
                            a.anime?.title.toLowerCase().includes(searchValue.toLowerCase()) ||
                ...
                if (filtered) {
                    filtered =
                        orderStrategy === "rating" ? orderByRating(filtered, "desc") : orderByName(filtered);
                }
