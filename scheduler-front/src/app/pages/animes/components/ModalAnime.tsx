...
export const ModalAnime : React.FC<IModalAnimeProps> = ({isOpen, onClose,  anime, animeSeason}) => {
    ...
    return (
        <>
            <Modal opened={isOpen} onClose={onClose} withCloseButton={false} centered size={880} radius="lg" closeOnClickOutside={false}>
                <ActionIcon variant="gradient" gradient={{ from: 'violet', to: 'grape' }} radius="xl" pos="absolute" right={10} top={10} onClick={onClose}>
                        ...
                        <Stack h="100%" spacing="xs">
...

                            {
                                animeSeason && <>
                                    ...
                                    <TextareaWithCounter maxCounter={900} label="Preview" value={preview} onChange={e => setPreview(e.currentTarget.value)}/>
                                    {/*<Textarea label="Preview" value={preview} onChange={e => setPreview(e.currentTarget.value)}/>*/}
                                    <TextareaWithCounter maxCounter={900} label="Review" value={review} onChange={e => setReview(e.currentTarget.value)}/>
