...
export const SearchHeaderAnime: React.FC<SearchHeaderAnimeProps> = ({searchValue, setSearchValue, season, setSeason, year, setYear, currentYear, orderStrategy, setOrderStrategy}) => {
    return(<>
            ...
            <Grid.Col span="content" ml="auto">
                <Group spacing={5}>
                    <Tooltip label="Ordernar por nome">
                        <ActionIcon size="lg" color={orderStrategy === "name" ? "grape.9" : "gray"} onClick={() => setOrderStrategy("name")}>
                            <FontAwesomeIcon icon={faArrowDownAZ} />
                        </ActionIcon>
                    </Tooltip>
                    <Tooltip label="Ordernar pela nota">
                        <ActionIcon size="lg" color={orderStrategy === "rating" ? "grape.9" : "gray"} onClick={() => setOrderStrategy("rating")}>
